...
% expression profiles of representative p53 targets (Fig. S2).

function main
%% Bseline parameters for the p53-Mdm2 system
alpha = 0.4; 
beta = 4;
gamma = 0.01;
sigma = 0.45;
...
%% Baseline parameters for the cryptic target (CT)
Psi_4 = 0.05;
h_4 = 2;
K_4 = 4;
Gamma_4 = 0.02;
...
% [EGFR transcript]_i, [EGFR]_i
% [CT transcript]_i, [CT]_i
